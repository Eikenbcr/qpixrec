...
g4_df = file.arrays(["hit_start_x","hit_end_x","hit_start_y","hit_end_y","hit_start_z","hit_end_z","hit_start_t","hit_end_t","hit_energy_deposit", "hit_track_id", "hit_process_key"], library="pd")
